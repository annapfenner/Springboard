...
### https://medium.com/featurepreneur/gradient-boosted-tree-classifier-model-using-pyspark-73281ff10109 
...
def print_performance_metrics(predictions):
  ...
  # F1
  print("F1 = {}".format(multi_metrics.weightedFMeasure(2.0)))
  # Precision
